...
import { APIPromise } from 'stainless/api-promise';

import util from 'node:util';
import Stainless2 from 'stainless';
import { APIUserAbortError } from 'stainless';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    afterEach(() => {
      process.env['STAINLESS_2_LOG'] = undefined;
    });
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Stainless2({ logger: logger, logLevel: 'debug', apiKey: 'My API Key' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Stainless2({ logger: logger, logLevel: 'info', apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['STAINLESS_2_LOG'] = 'debug';
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['STAINLESS_2_LOG'] = 'debug';
      const client = new Stainless2({ logger: logger, logLevel: 'off', apiKey: 'My API Key' });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['STAINLESS_2_BASE_URL'] = undefined;
    });
    ...
    test('env variable', () => {
      process.env['STAINLESS_2_BASE_URL'] = 'https://example.com/from_env';
      const client = new Stainless2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['STAINLESS_2_BASE_URL'] = ''; // empty
      const client = new Stainless2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.stainlessapi.com');
    });

    test('blank env variable', () => {
      process.env['STAINLESS_2_BASE_URL'] = '  '; // blank
      const client = new Stainless2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.stainlessapi.com');
    });
  });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Stainless2({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Stainless2({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
